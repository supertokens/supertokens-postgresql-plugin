...
- Schema is forward-compatible with the legacy table set. The new tables are created on first boot of this
  ...
  upgrade-only deploy is functionally identical to the prior version. See `SCHEMA-REWORK.md` in the
  `supertokens-core` repository for the end-to-end cutover runbook.
