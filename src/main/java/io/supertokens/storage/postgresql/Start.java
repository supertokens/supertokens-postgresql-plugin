...
public class Start
    ...
    public boolean removeUserIdFromTenant(TenantIdentifier tenantIdentifier, String userId)
        ...
        try {
            return this.startTransaction(con -> {
                Connection sqlCon = (Connection) con.getConnection();
                try {
                    boolean removed = removeUserIdFromTenant_Transaction(tenantIdentifier, con, userId);
                    sqlCon.commit();
                    return removed;
                } catch (StorageQueryException throwables) {
    ...
    public boolean removeUserIdFromTenant_Transaction(TenantIdentifier tenantIdentifier, TransactionConnection con,
        ...
        try {
            ...
            try {
                ...
                return false; // No auth user to remove; nothing was written
            }
    ...
    public void unlinkAccounts_Transaction(AppIdentifier appIdentifier, TransactionConnection con, String primaryUserId,
        ...
        try {
            ...
            if (mode.writesToNewTables()) {
                AccountInfoQueries.doRemoveAccountInfoReservationForUnlinking(this, sqlCon, appIdentifier, recipeUserId);
            }
        } catch (SQLException e) {
            throw new StorageQueryException(e);
        }
